          ...
          children: [
            ...
            Container(
              ...
              child: Stack(
                ...
                children: [
                  Container(height: Get.height*0.3,
            ...
            CommonWidget().customText(
                        'Mangalo requires access', blackColor, 28.0, FontWeight.w400,1),
            CommonWidget().sizedBox(2.0, 0.0),            
            CommonWidget().customText(
                        'to your location', blackColor, 28.0, FontWeight.w400,1),
            CommonWidget().sizedBox(10.0, 0.0),
            CommonWidget().customText(
                        'We would like to access your', greyColor, 20.0, FontWeight.w400,1),
            CommonWidget().customText(
                        'location so you can view products', greyColor, 20.0, FontWeight.w400,1),
            CommonWidget().customText(
                        'that are available near you.', greyColor, 20.0, FontWeight.w400,1),
              ],
            ),
          //! *******Buttons
          Expanded(
            child: Padding(
              ...
              CommonWidget().button(Colors.green, Colors.white,
               'Use current location', (){
                 Get.offAll(()=> BottomNavigation(initailIndex: 0,));},
               EdgeInsets.symmetric(vertical: 12),22.0,FontWeight.normal),
              CommonWidget().sizedBox(20.0, 0.0),
              CommonWidget().button(Colors.white, Colors.black,
               'Select location manually', (){
                 Get.to(()=> MapScreen(isFromHomePage: false,isFromCheckout: false,));
               },EdgeInsets.symmetric(vertical: 12),22.0,FontWeight.normal),
                ],
              ),
            ),
