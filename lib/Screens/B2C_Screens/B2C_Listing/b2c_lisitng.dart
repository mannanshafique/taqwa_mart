...
import 'package:mangalo_app/Screens/B2C_Screens/B2C_Listing/b2c_listing_controller.dart';

class B2CListing extends StatefulWidget {
  B2CListing({Key? key}) : super(key: key);

  @override
  State<B2CListing> createState() => _B2CListingState();
}

class _B2CListingState extends State<B2CListing> {
  final B2CListingController _listingController =
      Get.put(B2CListingController());
